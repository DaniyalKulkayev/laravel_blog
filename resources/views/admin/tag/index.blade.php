    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <a href="{{ route('admin.tag.create') }}" class="btn btn-block btn-primary col-1 mb-2">Create</a>
                </div>
                                ...
                                <tbody>
                                    @foreach($tags as $tag)
                                        <tr>
                                            <td>{{ $tag->id }}</td>
                                            <td>{{ $tag->title }}</td>
                                            <td><a href="{{ route('admin.tag.show', $tag->id) }}" class="pl-2"><i
                                                        class="far fa-eye"></i></a></td>
                                            <td><a href="{{ route('admin.tag.edit', $tag->id) }}" class="pl-2"><i
